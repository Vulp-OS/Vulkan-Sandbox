//////////////////////////////////////////////////////////////////////////////////
//		Setup code obtained and adapted from https://vulkan-tutorial.com/		//
//////////////////////////////////////////////////////////////////////////////////
...
void VulkanApplication::initWindow() {
	...
	window = glfwCreateWindow(WIDTH, HEIGHT, "Rockwood - Assignment 1", nullptr, nullptr);
...
void VulkanApplication::createInstance()
{
	...
	appInfo.pApplicationName = "Rockwood - Assignment 1";
...
void VulkanApplication::createGraphicsPipeline()
{
	...
	// Set the vertShaderModule to actually be associated with the Vertex Stage
	...
	// Set the fragShaderModule to actually be associated with the Fragment stage
	...
	rasterizer.depthClampEnable = VK_FALSE;		// Discards fragments beyond the near/far clip planes rather than clamping them
	rasterizer.rasterizerDiscardEnable = VK_FALSE;
	rasterizer.polygonMode = VK_POLYGON_MODE_FILL;
	rasterizer.lineWidth = 1.0f;
	rasterizer.cullMode = VK_CULL_MODE_BACK_BIT;
	rasterizer.frontFace = VK_FRONT_FACE_CLOCKWISE;		// IMPORTANT! We are using CLOCKWISE front face calculation
	...
	// Destroy the modules since we only needed them to set up all of the above
...
VkSurfaceFormatKHR VulkanApplication::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
	...
	return availableFormats[0];		// If we can't find the SRGB format, just pick the first preferred format for the SwapSurface
